...
// Constructor of class 'UniversityInfo' is private and 
// only accessible within the class declaration.
// let u = new UniversityInfo();

console.log("A student enters the university...");

// we can create as many instances as we want, but they will always use the same object (address). 
